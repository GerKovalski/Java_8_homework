...
public class Homework02 {
  ...
  public void transformAndProvideSumWithCounter() {
    //TODO: create your realization with lambda
    Function<String, Integer> transform = stringVar -> Integer.parseInt(stringVar);

    //TODO: create your realization with lambda
    BinaryOperator<Integer> increment = (var1, var2) -> var1 + var2;
  ...
  public void consumerPrintInPrintStream() {
    ...
    Consumer<Object> printHelloInSystemOut = in -> System.out.print(in);
  ...
  public void testPredicateScenario() {
    ...
    //TODO: create your realization with lambda
    Predicate<String> isStartsWithXX = stringVar -> stringVar.startsWith("XX");

    //TODO: create your realization with lambda
    Predicate<String> isEndWithZZZ = isStartsWithXX.and(stringVar -> stringVar.endsWith("ZZZ"));

    //TODO: create your realization with lambda
    Predicate<String> haveFiveStarsInRow = isEndWithZZZ.or(stringVar -> stringVar.contains("*****"));
  ...
  public void chainOfFunctionInvocation() {
    ...
    Predicate<Integer> isEven = var1 -> var1%2 == 0;
    ...
    Function<List<Integer>, List<Integer>> sumWithNextElement = list -> {
      ...
      for (int i = 0; i < list.size(); i++){
        if (i == list.size()-1){
          list1.add(list.get(i) + list.get(0));
        } else {
  ...
  private static Function<Predicate<String>, Function<String, String>> doubleStringOrAddThreeDots() {
    return stringVar -> str -> {
      if (stringVar.test(str)) {
