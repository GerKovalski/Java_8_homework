...
public class Homework04 {
  ...
  public void collectToMap() {
    ...
    Map<String, Integer> result = Arrays.stream(words)
        ...
        .collect(Collectors.toMap(word->word, value->1, (oldValue, newValue)->newValue+oldValue) );
  ...
  public void collectingAndThen() {
    ...
    List<String> result = Arrays.stream(words)
        ...
        .collect(Collectors.collectingAndThen(
            Collectors.toSet(),
            strings -> strings.stream().map(str->str.concat(str)).collect(Collectors.toList())
        ));
  ...
  public void convertFromUserToUserDTOTest() {
    ...
    List<UserDTO> result = usersFromDB.stream()
            ...
            .entrySet().stream()
            .map(stringListEntry -> new UserDTO(stringListEntry.getKey(), stringListEntry.getValue()))
