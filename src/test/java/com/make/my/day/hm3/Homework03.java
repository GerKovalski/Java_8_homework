...
public class Homework03 {
  ...
  public void createWithBuilder() {
    ...
    Stream<String> sut = Stream.<String>builder().add("Hello").add("Wonderful")
            .add("Word").build();
  ...
  public void iterateForNineHundredsElements() {
    ...
    Stream<Integer> stream = Stream.iterate(100, num -> ++num).limit(900);
  ...
  public void sortedByRepeatableChars() {
    ...
    String[] result = words.stream()
        ...
        .sorted((s1, s2) -> {
          long len1 = s1.length() - s1.chars().distinct().count();
          long len2 = s2.length() - s2.chars().distinct().count();
  ...
  public void uniqueValues() {
    ...
    int [] result = numbers.stream().distinct().mapToInt(a -> a).toArray();
